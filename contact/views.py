...
# def contact_post(request):
   # if request.method == "GET":
    ...
    # Pass your request through the Form
    # If valid, save the contents to the DB
    #   - models.py, class ContactMessages
    #   - Save the contact info there
    #return ...
